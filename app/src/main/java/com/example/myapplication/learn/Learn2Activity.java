...
public class Learn2Activity extends Activity implements AdapterView.OnItemSelectedListener {
    float oldx, oldy;
    ...
    public void onButton2Back(View v) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v  = (View)vi.inflate(R.layout.activity_learn2,null);
