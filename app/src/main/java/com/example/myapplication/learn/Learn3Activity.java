...
public class Learn3Activity extends Activity implements AdapterView.OnItemSelectedListener {
    float oldx, oldy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v  = (View)vi.inflate(R.layout.activity_learn3,null);
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (ar[position].equals("사각형")) {
                    renderer.option = "2";
                    text.setText("사각형의 넓이: 가로 * 세로");
                    surfaceView.requestRender();
                } else if (ar[position].equals("삼각형")) {
                    renderer.option = "1";
                    text.setText("삼각형의 넓이: (가로* 세로)/2");
                    surfaceView.requestRender();
                }   else if (ar[position].equals("원")) {
                    renderer.option = "8";
                    text.setText("원의 넓이: 반지름*반지름*3.14");
                    surfaceView.requestRender();
                }
            }
    ...
    public void onHome3Clicked(View v) {
