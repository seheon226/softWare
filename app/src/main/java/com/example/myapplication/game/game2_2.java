...
public class game2_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = (View) vi.inflate(R.layout.activity_game2_2, null);
        ...
        Button putText2 = (Button)findViewById(R.id.putText2);
        putText2.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                EditText answer2 = (EditText)findViewById(R.id.answer2);
                String correct2 = "정답";

                if(correct2.equals(answer2.getText().toString()))
                    Toast.makeText(getApplicationContext(), "정답!!!!!", Toast.LENGTH_SHORT).show();
                else if(answer2.getText().toString().length()==0)
