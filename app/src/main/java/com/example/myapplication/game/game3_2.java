...
public class game3_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = (View) vi.inflate(R.layout.activity_game3_2, null);
        ...
        Button putText3 = (Button)findViewById(R.id.putText3);
        putText3.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                EditText answer3 = (EditText)findViewById(R.id.answer3);
                String correct3 = "정답";

                if(correct3.equals(answer3.getText().toString()))
                    Toast.makeText(getApplicationContext(), "정답!!!!!", Toast.LENGTH_SHORT).show();
                else if(answer3.getText().toString().length()==0)
